...
public interface viewListeners {
    ...
    /**
     * Method that notify to the listeners if a player want
     * to try another time to enter the game with a different nickname (he tried before to enter the game
     * with a nickname already taken)
     *
     * @throws RemoteException Exception thrown if there are problems with the client-server connection
